        ...
        do{
            ...
            switch (opcio) {
                ...
                case 23: 
                    ...
                    Associacio assocTestt1 = new Associacio("AssociacióTest1", "test1@example.com", titulacionsTestt1, membresTestt1, "President1", "Secretari1", "Tresorer1", 3, 0);
                    String[] titulacionsTestt2 = {"GEB", "GESST"};
                    String[] membresTestt2 = {"Membre4", "Membre5", "Membre6"};
                    Associacio assocTestt2 = new Associacio("AssociacióTest2", "test2@example.com", titulacionsTestt2, membresTestt2, "President2", "Secretari2", "Tresorer2", 3, 0);
                    String[] titulacionsTestt3 = {"GEB", "GEI"};
                    String[] membresTestt3 = {"Membre7", "Membre8", "Membre9"};
                    Associacio assocTestt3 = new Associacio("AssociacióTest3", "test3@example.com", titulacionsTestt3, membresTestt3, "President3", "Secretari3", "Tresorer3", 3, 0);
                    String[] titulacionsTestt4 = {"GEB", "GESST"};
                    String[] membresTestt4 = {"Membre10", "Membre11", "Membre12"};
                    Associacio assocTestt4 = new Associacio("AssociacióTest4", "test4@example.com", titulacionsTestt4, membresTestt4, "President4", "Secretari4", "Tresorer4", 3, 0);
